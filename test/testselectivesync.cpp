...
private slots:
    ...
    void testSelectiveSyncBigFolders()
    {
        ...
        fakeFolder.remoteModifier().find("A/newBigDir")->extraDavProperties = "<oc:size>20010</oc:size>";
        fakeFolder.remoteModifier().find("A/newBigDir/subDir")->extraDavProperties = "<oc:size>20010</oc:size>";
